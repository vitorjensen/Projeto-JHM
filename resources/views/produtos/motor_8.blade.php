...
@section('main8')
    <main>
        <section class="container-sobre-motor">
            <img src="img/motores/W21-alto-rendimento-plus-1.jpg" alt="Motor">

            <div class="sobre-motor">
                <h2>W21 Alto Rendimento Plus</h2>

                <p>O Motor Trifásico Alto Rendimento Plus pode ser aplicado em bombas, ventiladores, exaustores, britadores, moinhos, talhas, compressores e outras aplicações que requerem motores assíncronos de indução trifásicos com o máximo de rendimento e consumo reduzido.
</p>
