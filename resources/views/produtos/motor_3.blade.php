...
@section('main3')
    <main>
        <section class="container-sobre-motor">
            <img src="img/motores/motor-freio-redutor-tipo-1.jpg" alt="Motor">

            <div class="sobre-motor">
                <h2>Moto Freio para Redutor tipo 1</h2>

                <p>Especialmente desenvolvida para a aplicação em redutores de velocidade, a linha de Motofreios para redutor  tipo 1 WEG é indicada para aplicações onde são exigidas paradas rápidas, posicionamento, economia de tempo e segurança como: talhas, pontes rolantes, elevadores, polias automáticas, guinchos e diversas máquinas operatrizes de uso geral.
</p>
