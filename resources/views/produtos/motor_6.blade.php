...
@section('main6')
    <main>
        <section class="container-sobre-motor">
            <img src="img/motores/w22-plus.jpg" alt="Motor">

            <div class="sobre-motor">
                <h2>W22 Plus</h2>

                <p>Os motores W22 Plus são motores de alta eficiência e possuem nível de rendimento similar ao Alto Rendimento Plus excedendo os níveis de rendimento definidos na portaria 553 da lei de eficiência energética 10.295, que está em vigor desde janeiro de 2010. Excelente relação custo-benefício, redução do consumo de energia elétrica, baixos níveis de ruído e vibração e fácil manutenção são algumas das características que definem esse novo produto. Um motor que surge antecipando conceitos sobre eficiência energética, desempenho e produtividade.
</p>
