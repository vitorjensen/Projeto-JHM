@extends('_layouts.produtos_index')
        ...
        <section class="container">
            ...
            <div class="container-motores">
                <div class="motores">
                    <img src="img/motores/motor-a-prova-de-explosao.jpg" alt="Motor à prova de explosão">
                    <p>Motor à Prova de Explosão</p>
                    <a href="{{route('route.motor_1')}}" class="botao-lermais"><p>Leia mais</p></a>
                </div>
                <div class="motores">
                    ...
                    <a href="{{route('route.motor_2')}}" class="botao-lermais"><p>Leia mais</p></a>
                </div>
                <div class="motores">
                    <img src="img/motores/motor-freio-redutor-tipo-1.jpg" alt="Moto Freio para redutor tipo 1">
                    <p>Moto Freio para Redutor Tipo 1</p>
                    <a href="{{route('route.motor_3')}}" class="botao-lermais"><p>Leia mais</p></a>
                </div>
                <div class="motores">
                    <img src="img/motores/motor-freio-alto-rendimento-plus.jpg" alt="Moto Freio alto rendimento plus">
                    <p>Moto Freio Alto Rendimento Plus</p>
                    <a href="{{route('route.motor_4')}}" class="botao-lermais"><p>Leia mais</p></a>
                </div>
                <div class="motores">
                    <img src="img/motores/w22-premium.jpg" alt="W22 Premium">
                    <p>W22 Premium</p>
                    <a href="{{route('route.motor_5')}}" class="botao-lermais"><p>Leia mais</p></a>
                </div>
                <div class="motores">
                    <img src="img/motores/w22-plus.jpg" alt="W22 Plus">
                    <p>W22 Plus</p>
                    <a href="{{route('route.motor_6')}}" class="botao-lermais"><p>Leia mais</p></a>
                </div>
            </div>
        </section>
