...
@section('main2')
    <main>
        <section class="container-sobre-motor">
            <img src="img/motores/motor-freio-a-prova-de-explosao.jpg" alt="Motor">

            <div class="sobre-motor">
                <h2>Motofreio à Prova de Explosão</h2>

                <p>A linha Motofreio à prova de explosão foi especialmente desenvolvida para aplicações em áreas de risco que precisem de frenagem, como talhas e pontes rolantes. Estes motores estão aptos a trabalhar em áreas classificadas tanto como Zona 1 quanto Zona 2, Grupo IIA/IIB, T4.</p>
