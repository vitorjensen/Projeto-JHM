...
@section('main5')
    <main>
        <section class="container-sobre-motor">
            <img src="img/motores/w22-premium.jpg" alt="Motor">

            <div class="sobre-motor">
                <h2>W22 Premium</h2>

                <p>Os motores W22 Premium são motores de altíssima eficiência e possuem o maior nível de rendimento do mercado, superando o W22 Plus e o Alto Rendimento Plus, excedendo os níveis de rendimento definidos na portaria 553 da lei de eficiência energética 10.295, em vigor desde de janeiro de 2010. Excelente relação custo-benefício, redução do consumo de energia elétrica, baixos níveis de ruído e vibração e fácil manutenção são algumas das características que definem esse novo produto. Um motor que surge antecipando conceitos sobre eficiência energética, desempenho e produtividade.
</p>

                <div class="btn-car">
                    <a href="#">Adicionar ao carrinho <i class="fa-solid fa-cart-plus"></i></a>
                </div>
            </div>
