...
@section('main9')
    <main>
        <section class="container-sobre-motor">
            <img src="img/motores/motor-w21-aluminio-multimontagem-weg.jpg" alt="Motor">

            <div class="sobre-motor">
                <h2>W21 Motor Trifásico IP55</h2>

                <p>O Motor Trifásico IP55 pode ser aplicado em bombas, ventiladores, exaustores, britadores, moinhos, talhas, compressores e outras aplicações que requerem motores assíncronos de indução trifásicos.
</p>
